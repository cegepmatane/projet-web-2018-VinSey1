	...
	<div id="contenu-index">
		<ul id="zone-categories-index">
			<div id="categories-index">
				...
				<button type="button" onclick="montrerProduitCategorie(2)"><?php echo gettext("Couverts"); ?></button>
				<button type="button" onclick="montrerProduitCategorie(3)"><?php echo gettext("Autre"); ?></button>
