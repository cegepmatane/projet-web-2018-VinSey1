...
<body>
    ...
    <nav>
        <ul>
			...
			<li><a href="vue/prive/achat.php" title="<?php echo gettext("Aller sur la page Achat")?>"><?php echo gettext("Page d'achat")?></a></li>
			<li><a href="vente.php" title="<?php echo gettext("Aller sur la page de vente")?>"><?php echo gettext("Page de vente")?></a></li>
			<li><a href="vue/prive/administration-utilisateur.php" title="<?php echo gettext("Administration utilisateur")?>"><?php echo gettext("Aministration utilisateur")?></a></li>
