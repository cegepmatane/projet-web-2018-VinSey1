...
<body>
    ...
    <nav>
        <ul>
			...
			<li><a href="administration-utilisateur.php" title="<?php echo gettext("Aller sur la page Administration utilisateur")?>"><?php echo gettext("dministration utilisateur")?></a></li>
